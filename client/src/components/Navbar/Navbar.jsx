      ...
      <div className="p-6 flex flex-col w-full  lg:w-[80px] justify-between h-auto lg:h-[640px] rounded-xl bg-[#161d2f]">
        <nav className="flex flex-row lg:flex-col justify-between items-center">
          ...
          <div
            ...
            className="w-8 h-8 border-[1px] border-white rounded-full relative lg:mt-48"
          >
            <img
            ...
            />
            {userMenu && (
              <ul className="absolute top-10 right-0 lg:top-0 lg:left-10 px-2 min-w-40 bg-[#161d2f] rounded-md text-white  z-10">
